    ...
    <div className='min-h-screen bg-white'>
      ...
      <nav className='flex justify-between items-center px-8 py-5 max-w-6xl mx-auto'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <Link
            href='/signup'
            className='text-sm bg-emerald-600 text-white px-5 py-2.5 rounded-xl hover:bg-emerald-700 font-medium transition-colors'
          >
            Get early access
          </Link>
        </div>
      ...
      <section className='relative overflow-hidden'>
        ...
        <div className='absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-emerald-100/30 rounded-full blur-3xl' />
      ...
      <section className='max-w-4xl mx-auto px-8 py-20'>
        <div className='text-center mb-14'>
          <p className='text-sm font-semibold text-emerald-600 mb-3 uppercase tracking-wide'>How it works</p>
