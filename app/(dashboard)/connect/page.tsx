...
function ConnectContent() {
  ...
  if (linearConnected || jiraConnected) {
    ...
    return (
      <div className='min-h-screen bg-[#F4F5F8] dark:bg-[#111318] flex items-center justify-center'>
        <div className='text-center max-w-sm'>
          <h1 className='text-xl font-bold text-gray-900 dark:text-white mb-2'>{service} connected</h1>
          <p className='text-gray-500 dark:text-white/40 text-sm'>You can now push opportunities to {service}.</p>
        </div>
      </div>
    )
  }
