      ...
      <div className='w-full max-w-sm'>
        ...
        <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-8'>
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div>
              <label htmlFor='tech_stack' className='block text-sm font-medium text-gray-700 mb-1.5'>
            ...
            <button
              type='submit'
              disabled={loading}
              className='w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-medium py-2.5 rounded-xl text-sm transition-colors cursor-pointer disabled:cursor-not-allowed'
            >
          ...
          <p className='text-gray-500 text-sm text-center mt-6'>
            ...
            <Link href='/signin' className='text-blue-600 hover:text-blue-700 font-medium'>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
