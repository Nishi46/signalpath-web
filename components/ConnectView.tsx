    ...
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='flex items-center justify-center p-8 mt-10'>
        <div className='bg-white rounded-2xl shadow-sm border border-gray-200 p-10 max-w-md w-full text-center'>
          <div className='w-14 h-14 bg-indigo-50 rounded-2xl mx-auto mb-6 flex items-center justify-center'>
          ...
          <div className='flex rounded-xl border border-gray-200 overflow-hidden mb-2 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-transparent transition-all'>
            <input
              type='text'
              value={subdomain}
          ...
          <button
            ...
            className='w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-medium py-3 rounded-xl text-sm transition-colors cursor-pointer disabled:cursor-not-allowed'
          >
